...
PyPI **pythonic-fp.queues** project. FIFO, LIFO, and DE queues.
...
- docs for all grscheller namespace projects maintained [here](https://grscheller.github.io/grscheller-pypi-namespace-docs/).
